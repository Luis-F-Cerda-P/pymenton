class AttributeValuesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @attribute_value.save
        format.html { redirect_to attribute_value_url(@attribute_value), notice: "Attribute value was successfully created." }
  ...
  def update
    respond_to do |format|
      if @attribute_value.update(attribute_value_params)
        format.html { redirect_to attribute_value_url(@attribute_value), notice: "Attribute value was successfully updated." }
  ...
  private
    ...
    def attribute_value_params
      params.require(:attribute_value).permit(:name, :attribute_field_id)
    end
end
