class LocationTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @location_type.save
        format.html { redirect_to location_type_url(@location_type), notice: "Location type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @location_type.update(location_type_params)
        format.html { redirect_to location_type_url(@location_type), notice: "Location type was successfully updated." }
  ...
  private
    ...
    def location_type_params
      params.require(:location_type).permit(:description)
    end
end
