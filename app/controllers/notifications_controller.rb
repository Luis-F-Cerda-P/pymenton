class NotificationsController < ApplicationController
  http_basic_authenticate_with name: Rails.application.credentials.admin_user[:username],
                               password: Rails.application.credentials.admin_user[:password], except: %i[index show create]
  ...
  def check_ip_whitelist
    ...
    return if allowed_ips.include?(request.env['HTTP_FLY_CLIENT_IP'])
