...
class ContainerTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create container_type" do
    assert_difference("ContainerType.count") do
      post container_types_url, params: { container_type: { description: @container_type.description } }
    end
  ...
  test "should update container_type" do
    patch container_type_url(@container_type), params: { container_type: { description: @container_type.description } }
