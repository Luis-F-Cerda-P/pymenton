...
class ContainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create container" do
    assert_difference("Container.count") do
      post containers_url, params: { container: { container_type_id: @container.container_type_id, description: @container.description, facility_id: @container.facility_id } }
    end
  ...
  test "should update container" do
    patch container_url(@container), params: { container: { container_type_id: @container.container_type_id, description: @container.description, facility_id: @container.facility_id } }
