...
class GoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create good" do
    assert_difference("Good.count") do
      post goods_url, params: { good: { description: @good.description, introduction_date: @good.introduction_date, party_id: @good.party_id, sales_discontinuation_date: @good.sales_discontinuation_date } }
    end
  ...
  test "should update good" do
    patch good_url(@good), params: { good: { description: @good.description, introduction_date: @good.introduction_date, party_id: @good.party_id, sales_discontinuation_date: @good.sales_discontinuation_date } }
