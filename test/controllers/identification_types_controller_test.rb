...
class IdentificationTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create identification_type" do
    assert_difference("IdentificationType.count") do
      post identification_types_url, params: { identification_type: { description: @identification_type.description } }
    end
  ...
  test "should update identification_type" do
    patch identification_type_url(@identification_type), params: { identification_type: { description: @identification_type.description } }
