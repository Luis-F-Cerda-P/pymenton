...
class IdentifierTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create identifier_type" do
    assert_difference("IdentifierType.count") do
      post identifier_types_url, params: { identifier_type: { description: @identifier_type.description } }
    end
  ...
  test "should update identifier_type" do
    patch identifier_type_url(@identifier_type), params: { identifier_type: { description: @identifier_type.description } }
