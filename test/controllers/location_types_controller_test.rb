...
class LocationTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create location_type" do
    assert_difference("LocationType.count") do
      post location_types_url, params: { location_type: { description: @location_type.description } }
    end
  ...
  test "should update location_type" do
    patch location_type_url(@location_type), params: { location_type: { description: @location_type.description } }
