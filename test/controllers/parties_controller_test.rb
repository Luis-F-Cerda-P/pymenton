...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference("Party.count") do
      post parties_url, params: { party: { description: @party.description, party_type_id: @party.party_type_id } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { description: @party.description, party_type_id: @party.party_type_id } }
