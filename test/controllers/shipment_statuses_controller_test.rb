...
class ShipmentStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment_status" do
    assert_difference("ShipmentStatus.count") do
      post shipment_statuses_url, params: { shipment_status: { shipment_id: @shipment_status.shipment_id, shipment_status_type_id: @shipment_status.shipment_status_type_id } }
    end
  ...
  test "should update shipment_status" do
    patch shipment_status_url(@shipment_status), params: { shipment_status: { shipment_id: @shipment_status.shipment_id, shipment_status_type_id: @shipment_status.shipment_status_type_id } }
