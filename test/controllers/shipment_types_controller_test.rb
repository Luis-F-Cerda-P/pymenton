...
class ShipmentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment_type" do
    assert_difference("ShipmentType.count") do
      post shipment_types_url, params: { shipment_type: { description: @shipment_type.description } }
    end
  ...
  test "should update shipment_type" do
    patch shipment_type_url(@shipment_type), params: { shipment_type: { description: @shipment_type.description } }
