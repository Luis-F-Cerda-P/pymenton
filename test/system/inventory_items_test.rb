...
class InventoryItemsTest < ApplicationSystemTestCase
  ...
  test "should create inventory item" do
    ...
    fill_in "Container", with: @inventory_item.container_id
    fill_in "Facility", with: @inventory_item.facility_id
    fill_in "Good", with: @inventory_item.good_id
    fill_in "Lot", with: @inventory_item.lot_id
