...
class OrderItemsTest < ApplicationSystemTestCase
  ...
  test "should create order item" do
    ...
    fill_in "Amount paid per unit", with: @order_item.amount_paid_per_unit
    fill_in "Feature applicability", with: @order_item.feature_applicability_id
    fill_in "Good", with: @order_item.good_id
